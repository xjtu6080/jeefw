 ...
 */
@Controller
@RequestMapping("/sys/checkserver")
public class CheckServerController extends JavaEEFrameworkBaseController<Server> implements Constant {
	...
	public void getDict(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		JqGridPageView<Server> dictListView = new JqGridPageView<Server>();
		dictListView.setMaxResults(maxResults);
		List<Server> dictWithSubList = checkServer.queryCeShiWithSubList(queryResult.getResultList());
