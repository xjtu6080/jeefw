...
public class SysUserController extends JavaEEFrameworkBaseController<SysUser> implements Constant {
	...
	public String checkserver(HttpServletRequest request, HttpServletResponse response) throws IOException {
		return "back/servermanagement/checkserver";
	}
	
	@RequestMapping("/myservermanagement")
	public String myservermanagement(HttpServletRequest request, HttpServletResponse response) throws IOException {
		return "back/servermanagement/myservermanagement";
	}
	
	
	@RequestMapping("/cluster")
	public String cluster(HttpServletRequest request, HttpServletResponse response) throws IOException {
		return "back/clustermanagement/cluster";
	}
	
	@RequestMapping("/clusterdetail")
	public String clusterdetail(HttpServletRequest request, HttpServletResponse response) throws IOException {
		return "back/clustermanagement/clusterdetail";
	}
	
	@RequestMapping("/rendertask")
	public String rendertask(HttpServletRequest request, HttpServletResponse response) throws IOException {
		return "back/rendermanagement/rendertask";
	}
	
	
	
	
	@RequestMapping("/rendercluster")
	public String rendercluster(HttpServletRequest request, HttpServletResponse response) throws IOException {
		return "back/rendermanagement/rendercluster";
	}
	
	
	@RequestMapping("/addrender")
	public String addrender(HttpServletRequest request, HttpServletResponse response) throws IOException {
		return "back/rendermanagement/addrender";
	}
	
	

	@RequestMapping("/container")
	public String container(HttpServletRequest request, HttpServletResponse response) throws IOException {
		return "back/containermanagement/container";
	}
	...
	public String userdefined(HttpServletRequest request, HttpServletResponse response) throws IOException {
		//return "back/bootstrapexample/typography";
		return "back/userdefined/usermade";
		//   back/userdefined/userdefined
	}

	@RequestMapping("/applymade")
	public String applymade(HttpServletRequest request, HttpServletResponse response) throws IOException {
		return "back/userdefined/applymade";
		//return "back/userdefined/usermade";
		//   back/userdefined/userdefined
	}
}
