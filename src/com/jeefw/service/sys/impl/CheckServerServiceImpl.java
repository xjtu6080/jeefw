...
import com.jeefw.dao.sys.CheckServerDao;
 ...
 */
@Service
public class CheckServerServiceImpl extends BaseService<Server> implements CheckServerService {

	private CheckServerDao checkserverDao;

	@Resource
	public void setCeShiDao(CheckServerDao checkserverDao) {
