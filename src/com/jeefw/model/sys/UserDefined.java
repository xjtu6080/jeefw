...
import com.jeefw.model.sys.param.UserDefinedParameter;
...
public class UserDefined extends UserDefinedParameter {

    // 各个字段的含义请查阅文档的数据库结构部分UserDefined
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final UserDefined other = (UserDefined) obj;
