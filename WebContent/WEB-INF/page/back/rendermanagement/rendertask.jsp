        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/rendertask/getDict",
        			datatype : "json",
        			height : 450,
        			colNames : ['', 'ID',  '服务名','渲染集群宿主机IP','文件路径', '宿主集群'],
        			colModel : [ {
        				name : '',
        				index : '',
        				width : 80,
        			...
        			formatter : 'actions', 
        				...
        				name : 'renderClusterName',
        				index : 'renderClusterName',
        				label : '宿主集群',
        				width : 110,
        				editable : true,
        				editoptions : {size : "20", maxlength : "20", title : "如果没有上级，不填即可"},
        			...
        			editurl : "${contextPath}/sys/rendertask/operateDict"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
